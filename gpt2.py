...
model_config = r'C:\Users\USER\Documents\new\yolov3-tiny.cfg'  # Path to YOLOv3 model configuration file
model_weights = r'C:\Users\USER\Documents\new\yolov3-tiny.weights'  # Path to YOLOv3 model weights file

# Load YOLO class labels
with open(r'C:\Users\USER\Documents\new\coco (1).names', 'r') as f:
